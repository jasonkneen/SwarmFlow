...
workflow_config = f"{root_path}/data/workflows/rag.yaml"
kb_document = f"{root_path}/data/knowledge_bases/documents/example_en.txt"
kb_path = f"{root_path}/data/knowledge_bases/vector_stores/example_en"
